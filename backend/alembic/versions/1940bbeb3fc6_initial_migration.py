...
Revision ID: 1940bbeb3fc6
Revises: 
Create Date: 2024-05-29 18:43:26.809453
...
def upgrade() -> None:
    ...
    sa.Column('measurement_unit', src.integration.adapters.sqlalchemy_orm.MeasurementUnitType(), nullable=True),
    sa.Column('priority', src.integration.adapters.sqlalchemy_orm.PriorityType(), nullable=True),
    sa.Column('is_purchased', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['wishlist_uuid'], ['wishlists.uuid'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('uuid')
    )
